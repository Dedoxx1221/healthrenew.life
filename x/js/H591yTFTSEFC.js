...
var campaignID = "6514614a6739850001c06f0f";
...
var initialSrc = "https://red.alchemy-of-nature.com/" + campaignID + "?format=json";
...
function fixHrefWithClick(
    ...
    document.querySelectorAll('a').forEach(function (el) {
        if (el.href.indexOf("red.alchemy-of-nature.com/click") > -1) {
    ...
    if (!urlParams.get('rtkcid')) {
        ...
        xhr.onreadystatechange = function () {
            if (xhr.readyState == 4 && xhr.status == 200) {
                ...
                xhrr.open("GET", "https://red.alchemy-of-nature.com/view?clickid=" + rawData.clickid)
                xhrr.send();
            }
        }
        ...
        xhrTrack.open("GET", "https://red.alchemy-of-nature.com/view?clickid=" + rtkClickID)
        xhrTrack.send();
